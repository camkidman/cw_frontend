System.register(['angular2/core', './services/user.service', './login-form.component', './services/api.service', "./services/http.service", "angular2/router", './registration.component', './confirmation.component', './user-dashboard.component', "./personal-detail-form.component", "./initial-test-form.component"], function(exports_1) {
    ...
    var core_1, user_service_1, login_form_component_1, api_service_1, http_service_1, router_1, registration_component_1, confirmation_component_1, user_dashboard_component_1, personal_detail_form_component_1, initial_test_form_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (initial_test_form_component_1_1) {
                initial_test_form_component_1 = initial_test_form_component_1_1;
            }],
        execute: function() {
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    ...
                    router_1.RouteConfig([
                        ...
                        { path: '/initial_test_form', name: 'InitialTestForm', component: initial_test_form_component_1.InitialTestFormComponent }
                    ]), 
